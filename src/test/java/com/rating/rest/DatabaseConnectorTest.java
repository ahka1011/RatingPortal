...
public class DatabaseConnectorTest {
	...
	public void studentKursListeSuchenStudentDa() {
		...
		assertEquals("Student sollte da sein", 1, DatabaseConnector.searchforCoursesbyUsername(iz_kuerzel_working).size());
	...
	public void studentKursListeSuchenStudentNichtDa() {
		...
		assertEquals("Student sollte nicht da sein", 0, DatabaseConnector.searchforCoursesbyUsername(iz_kuerzel_not_working).size());
	...
	public void dozentKursListeSuchenDa() {
		...
		assertEquals("Student sollte da sein", 1, DatabaseConnector.searchforCoursesbyProf(iz_kuerzel_working).size());
		Assert.assertNotNull(iz_kuerzel_working);
	}*/
	...
	public void dozentKursListeSuchenNichtDa() {
		final String iz_kuerzel_not_working = "asadfhakdsf";
		assertEquals("Student sollte nicht da sein", 0, DatabaseConnector.searchforCoursesbyProf(iz_kuerzel_not_working).size());
		Assert.assertNotNull(iz_kuerzel_not_working);
	}*/
