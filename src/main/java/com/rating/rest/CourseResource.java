...
public class CourseResource extends BaseResource {
    ...
    class CourseDetailStudent {
        ...
        Professor prof;
        public CourseDetailStudent(int kurs_nr, String iz_kuerzel) {
            List<Kursvorlage> k = DatabaseConnector.vorlage(kurs_nr);
            prof = new Professor();
    ...
    class CourseDetailProfessor {
        ...
        public CourseDetailProfessor(String iz_kuerzel, String kurs_nr) {
            Kursvorlage k = DatabaseConnector.vorlage(kurs_nr);
            prof = new Professor();
            prof = DatabaseConnector.profInfo(iz_kuerzel);
            studenten = new ArrayList<Student>();
            studenten = DatabaseConnector.studentenZuKursSuchen(izKuerzel);
    ...
    public List<CourseDetailStudent> getCourseDetailsStudent(@HeaderParam("token") String token,
    ...
    public List<CourseOverviewProfessor> getCourseDetailsProfessor(@HeaderParam("token") String token,
            @PathParam("id") String id) {
        try {
            if (isValid(token)) {
